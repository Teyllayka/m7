...
function t_zeroForms__createForm(t, e, r, o) {
    ...
    var l,
        ...
        a =
            ...
            { color: n.inputtitlecolor || "", fontWeight: n.inputtitlefontweight || "", fontFamily: n.inputfontfamily || "", fontSize: n.inputtitlefontsize || "", paddingBottom: n.inputtitlemargbottom || "" }),
        i = t_zeroForms__generateInputsBlock(t, o, r, n, a),
        c = (s.insertAdjacentElement("beforeend", i), o.getAttribute("data-elem-id")),
        r = n.formbottomtext && n.formbottomtext.trim(),
        i =
            (r &&
                (((i = document.createElement("div")).style.textAlign = "center" === n.buttonalign ? "center" : "left"),
                (i.style.color = a.color),
                (i.style.fontWeight = a.fontWeight),
                (i.style.fontFamily = a.fontFamily),
                (i.style.marginTop = "15px"),
                (i.style.fontSize = "13px"),
                (a = t_zeroForms__getBottomText(c, n, t, o, r)),
                i.appendChild(a),
                s.insertAdjacentElement("beforeend", i)),
            ...
            t_zeroForms__createInputPlaceholderStyles(c, n, t, o),
            ("h" !== n.inputpos && "zero" !== e) ||
                (t_zeroForms__setScriptOrStyle((r = "t-zero-form-h-styles"), "tilda-zero-form-horizontal.min.css", "", "link", !1),
            ...
            "y" === n.inputsstyle2 &&
                t_zeroForms__onRender(o, !1, function () {
                    t_zeroForms__animateInputs(o, n, t, c);
                }),
            "t-zero-form-font-family-" + t + "-" + c),
        i =
            (n.fieldfontfamily
                ? ((l = t_zeroForms__createSelector(t, c, "")),
                  t_zeroForms__setScriptOrStyle(
                      i,
                      "",
                      (_ = (_ = ['input[type="text"]', 'input[type="tel"]', ".t-input-phonemask__select", "textarea", "select", ".t-input__vis-ph"]).reduce(function (t, e, r) {
                          return (t += l + ".t-input-block " + e), r !== _.length - 1 && (t += ", "), t;
                      }, "")) +
                          ' {font-family: "' +
                          n.fieldfontfamily +
                          '";}',
                ...
                : (r = document.getElementById(i)) && r.parentElement && r.parentElement.removeChild(r),
            ("preview" !== e && "published" !== e) ||
                t_zeroForms__onFuncLoad("tildaForm_initMasks", function () {
                    tildaForm_initMasks();
                }),
            "published" === e &&
                ((a = document.querySelectorAll('[data-record-type="803"]')),
    ...
    return (
        window.addEventListener(i, function () {
            u =
                u ||
                setTimeout(function () {
                    t_zeroForms__updateCurrentResolution(t, d), t_zeroForms__updateStylesOnResize(t, o), clearTimeout(u), (u = 0);
                }, 600);
        }),
        s
    );
...
function t_zeroForms__updateStylesOnResize(t, e) {
    var r = t_zeroForms__createFormObj(t, e),
        ...
        s =
            ...
            "h" === r.inputpos ? (n && n.classList.add("tn-form_horiz"), t_zeroForms__setScriptOrStyle("t-zero-form-h-styles", "tilda-zero-form-horizontal.min.css", "", "link", !1)) : n && n.classList.remove("tn-form_horiz"),
        ...
        l =
            ...
            { color: r.inputtitlecolor || "", fontWeight: r.inputtitlefontweight || "", fontFamily: r.inputfontfamily || "", fontSize: r.inputtitlefontsize || "", paddingBottom: r.inputtitlemargbottom || "" }),
    ...
    a &&
        ...
        (n = a.closest(".tn-form__submit")) && ((n.style.textAlign = r.buttonalign), (n.style.marginTop = r.buttonmargtop + "px"), t_zeroForms__updateTopPosition(e)));
}
...
function t_zeroForms__generateInputsBlock(e, r, t, o, n) {
    ...
    return (
        ...
        a.insertAdjacentElement("beforeend", t_zeroForms__createErrorBox(o, "middle")),
        a.insertAdjacentElement("beforeend", t_zeroForms__createFormButton(e, r, i, o)),
        a
    );
}
function t_zeroForms__parseIntoElement(e, r, o, n, t, i) {
    ...
    var a,
        ...
        _ =
            (l.classList.add("t-input-group"),
            l.classList.add("t-input-group_" + o.li_type),
            l.setAttribute("data-input-lid", o.lid),
            t_zeroForms__setStylesForFormGroup(n, l),
            "variation" === n.inputfontweight ? n.inputvariationweight : n.inputfontweight),
        c = "variation" === n.inputelsfontweight ? n.inputelsvariationweight : n.inputelsfontweight,
        d = "variation" === n.inputtitlefontweight ? n.inputtitlevariationweight : n.inputtitlefontweight,
        u = (o.li_title && t_zeroForms__generateTitle(o, t, l, d), o.li_subtitle && t_zeroForms__generateSubtitle(o, t, l), t_zeroForms__initInputStyles(n, _)),
    ...
    switch ((d.classList.add("t-input-block"), o.li_type)) {
        case "em":
            b = t_zeroForms__createInput(o, u, p, "email");
            break;
        case "ph":
            (b = t_zeroForms__createPhoneInput(e, o, u, p)),
                "a" === o.li_masktype &&
        ...
        case "ta":
            ...
            break;
        case "sb":
            var f = "y" === n.inputsstyle,
                b = t_zeroForms__createSelect(o, u, p, f);
            ((n.inputsstyle && n.inputelscolor) || u.color) &&
                ((f = document.createElement("style")),
                (g = t_zeroForms__createSelector(e, i, ".t-select__wrapper:after")),
                (F = n.inputsstyle ? n.inputelscolor : u.color),
                (f.textContent = g + "{border-top-color:" + F + ";}"),
                b.insertAdjacentElement("beforeend", f));
            break;
        case "rd":
            var g = "cb" === o.li_radcb ? "checkbox" : "radio",
                F = ((b = t_zeroForms__createRadio(o, n, p, m, g, e, i)), t_zeroForms__setIndicatorStyles(e, i, n.inputelscolor, g, b), e ? "#rec" + e + " " : "");
            t_zeroForms__setScriptOrStyle("t-zero-form-fieldset-" + e, "", (F += "fieldset {padding: 0; margin: 0; border: none;}"), "style", r),
                "checkbox" == g &&
            ...
            break;
        case "ri":
            (b = t_zeroForms__createRadioImage(o, n, p)),
                t_zeroForms__setIndicatorStyles(e, i, n.inputelscolor, "img-select", b),
        ...
        case "cb":
            ...
            break;
        case "uw":
            (b = t_zeroForms__createUploadField(o, p, "uw")),
        ...
        case "uc":
            ...
            break;
        case "da":
            (b = t_zeroForms__createDateField(o, p, u, n)),
                t_zeroForms__onRender(r, !0, function () {
        ...
        case "qn":
            ...
            break;
        case "rg":
            (b = t_zeroForms__createQuantityRange(o, u, n, p)),
                n.inputelscolor &&
        ...
        case "tx":
            (b = document.createElement("div")).classList.add("t-text"),
                b.setAttribute("field", "li_text__" + o.lid),
                (b.style.fontWeight = m.fontWeight),
                (b.style.fontSize = m.fontSize + "px"),
                (b.style.fontFamily = t.fontFamily),
                (b.style.color = t.color),
                (b.innerHTML = o.li_text || "");
            break;
        case "ws":
            ...
            break;
        case "fr":
            (b = t_zeroForms__createCalculation(o, u, p, t)),
                n.inputfrbgcolor &&
                    ((F = document.createElement("style")),
                    (g = t_zeroForms__createSelector(e, i, ".t-input-group_fr")),
                    (F.textContent = g + "{background-color:" + n.inputfrbgcolor + "; padding: 20px 30px 25px;}"),
                    b.insertAdjacentElement("beforeend", F)),
                t_zeroForms__onRender(r, !1, function () {
    ...
    return (
        _.classList.add("t-input-error"),
        d.insertAdjacentElement("beforeend", _),
        l.insertAdjacentElement("beforeend", d),
        "h" !== n.inputpos &&
            (("em" !== (c = o.li_type) && "ph" !== c && "nm" !== c && "in" !== c && "ta" !== c && "sb" !== c && "cb" !== c && "uw" !== c && "da" !== c && "tm" !== c && "qn" !== c && "rg" !== c && "ur" !== c && "tx" !== c) ||
                t_zeroForms__setFieldsRowClasses(p, l),
            "rd" === o.li_type && t_zeroForms__setRadioRowClasses(p, d)),
        l
    );
}
...
function t_zeroForms__createPhoneInput(t, e, r, o) {
    ...
    return (
        ...
        "a" === n
            ...
            : (t_zeroForms__appendAttributes(i, o), i.setAttribute("data-tilda-rule", "phone"), o.mask && i.setAttribute("data-tilda-mask", o.mask)),
...
function t_zeroForms__createSelect(t, o, e, r) {
    var n = t.li_variants ? t.li_variants.split("\n") : [],
        ...
        l =
            ...
            t_zeroForms__appendMainSettingToField(s, e, "", "t-select"),
            e.secondaryClassName && s.classList.add("t-select_bbonly"),
            e.require && s.setAttribute("data-tilda-req", "1"),
            t_zeroForms__appendStylesToField(s, o),
            t.li_selfirstvar && (((e = document.createElement("option")).textContent = t.li_selfirstvar), e.setAttribute("value", ""), s.insertAdjacentElement("beforeend", e)),
            o && o.color && !r);
    return (
...
function t_zeroForms__createRadio(i, a, s, l, _, c, d) {
    ...
    return (
        t.forEach(function (t, e) {
            ...
            (e.textContent = t),
                ...
                t === i.li_ownvariant ? ((n = t_zeroForms__createStyleObjectForOwnAnswer(l, a)), (e = t_zeroForms__createOwnAnswer(o, r, i, n, s, c, d)), p.insertAdjacentElement("beforeend", e)) : p.insertAdjacentElement("beforeend", r);
        }),
        e && i.li_ownvariant && t_zeroForms__updateOwnAnswerVisibility(f, p),
        r
    );
}
...
function t_zeroForms__processOwnAnswerPlaceholder(t, e, r, o, n, i) {
    t &&
        ((e.placeholder = t),
        r.color && ((e = document.createElement("style")), (t = t_zeroForms__createSelector(o, n, ".t-input__own-answer::placeholder")), (e.textContent = t + "{color:" + r.color + ";}"), i.insertAdjacentElement("afterend", e)));
}
function t_zeroForms__setListenersForOwnAnswer(o, n) {
    n.addEventListener("blur", function (t) {
        var e = n.value && n.value.trim(),
            r = o.defaultRadioValue || "";
...
function t_zeroForms__updateOwnAnswerVisibility(t, n) {
    t.forEach(function (o) {
        o.addEventListener("change", function () {
            var t,
                e = n.querySelector(".t-input__own-answer"),
                r = n.querySelector(".t-input__own-answer-input");
...
function t_zeroForms__createRadioImage(n, i, a) {
    ...
    if (t)
        return (
            ...
            i.shouldUseTwoColumnRadioImg && l.classList.add("t-img-select__container__mobile_2-in-row"),
            l.setAttribute("data-check-bgcolor", i.inputelscolor || "#000"),
            d && e.appendChild(t_zeroForms__createNameFieldForCheckbox(a, l, "img-select")),
            e.appendChild(l),
            (_ = d ? "checkbox" : "radio"),
            (c = "t-img-select__indicator_" + (n.li_imgratio ? n.li_imgratio.replace("_", "-") : "1-1")),
            t.forEach(function (t, e) {
                var r = t_zeroForms__createLabel("img-select", "", !1),
                    ...
                    e =
                        ...
                        r.insertAdjacentElement("beforeend", o),
                        t_zeroForms__createIndicator("img-select", !1, { ratio: c, img: t.img }));
                e.classList.add("t-bgimg"),
                    ...
                    r.insertAdjacentElement("beforeend", e),
                    t.alt &&
                        ((o = document.createElement("div")).classList.add("t-img-select__text"),
...
function t_zeroForms__createUploadField(t, e, r) {
    ...
    var o = r ? "t-upwidget" : "t-uploadcare",
        ...
        e =
            ...
            (i.style.display = "none"),
            r ? (i.setAttribute("data-tilda-upwidget-key", t.li_uwkey || ""), "y" === t.li_multiupl && i.setAttribute("data-tilda-upwidget-multiple", "1")) : i.setAttribute("data-public-key", t.li_uckey || "demopublickey"),
            n.insertAdjacentElement("beforeend", i),
            r ? "tilda-upwidget-1.1.min.js" : "uploadcare-3.x.min.js");
    return "uploadcare-3.x.min.js" !== e || window.jQuery || (e = "uploadcare-3.x.full.min.js"), (!r && document.querySelector('script[src*="uploadcare-3.x"]')) || t_zeroForms__setScriptOrStyle(o + "-zero-form", e, "", "script", !1), n;
}
...
function t_zeroForms__createQuantityField(t, e, r, o) {
    ...
    return (
        t_zeroForms__appendMainSettingToField(a, o, "text", ["t-input", "t-inputquantity"]),
...
function t_zeroForms__createCalculation(t, e, r, o) {
    ...
    return (
        ...
        i.setAttribute("data-calc-expr", t_zeroForms__removeStringQuotes(t.li_expr)),
        (i.textContent = "0"),
        ...
        n.appendChild(r),
        "y" !== t.li_addtocart ||
            (t.li_prod_title && ((o = t_zeroForms__createHiddenField(t.li_prod_title, "prod_title", "t-calc__hidden__prod_title")), r.insertAdjacentElement("beforeend", o)),
            t.li_prod_img && ((e = t_zeroForms__createHiddenField(t.li_prod_img, "prod_img", "t-calc__hidden__prod_img")), r.insertAdjacentElement("beforeend", e))),
        n
    );
}
...
function t_zeroForms__generateBtnStyles(t, e, r, o, n) {
    var i = t_zeroForms__generateButtonStyles(o, window.getComputedStyle(t).fontFamily),
        a = t_zeroForms__generateButtonHoverStyles(o),
        s = document.getElementById("t-uploadcare-zero-form") || document.querySelector('script[src*="uploadcare-3.x"]'),
        l = document.getElementById("t-upwidget-zero-form"),
        _ = t_zeroForms__createSelector(e, r, ""),
        c = _ + ".t-submit",
        o = t_zeroForms__getGradientBGStyles(o, c),
        s = (s && (c = c + ", " + _ + ".uploadcare--widget__button.uploadcare--widget__button_type_open"), a ? "transition: 0.3s ease all;" : ""),
        l = (c = l ? c + ", " + _ + ".t-upwidget-container__button" : c) + "{" + i + s + "}",
    ...
    i && i.parentElement && i.parentElement.removeChild(i),
        t_zeroForms__setScriptOrStyle(_, "", l, "style", n),
        a &&
            ((s =
                c
                    .split(", ")
                ...
                a +
                "}"),
            (o = "t-zero-form-btn-hover-styles-" + r + "-" + e),
            (t = document.getElementById(o)) && t.parentElement && t.parentElement.removeChild(t),
            t_zeroForms__setScriptOrStyle(o, "", s, "style", n));
}
...
function t_zeroForms__processButtonBG(t, e) {
    var t = t_zeroForms__getButtonBGObj(t),
        r = e ? t.buttonHoverBG : t.buttonBG;
...
function t_zeroForms__getButtonBGObj(t) {
    var e = t.buttonbgcolor,
        t = t.buttonhoverbgcolor;
    return { buttonBG: e, buttonHoverBG: t, buttonBGHasGradient: t_zeroForms__isColorContainsGradient(e), buttonHoverBGHasGradient: t_zeroForms__isColorContainsGradient(t) };
}
...
function t_zeroForms__getGradientBGStyles(t, e) {
    var t = t_zeroForms__getButtonBGObj(t),
        r = t.buttonBGHasGradient,
        o = t.buttonHoverBGHasGradient,
        n = t.buttonBG,
        t = t.buttonHoverBG;
    if (!r && !o) return "";
    var i = "";
...
function t_zeroForms__generateButtonHoverStyles(t) {
    ...
    var e,
        r = { color: t.buttonhovercolor || "", "border-color": t.buttonhoverbordercolor || "" },
        o =
            ((t.buttonhovershadowsize || t.buttonshadowopacity) &&
                (r["box-shadow"] = "0px 0px " + (t.buttonhovershadowsize ? t.buttonhovershadowsize + "px" : "10px") + " 0px rgba(0, 0, 0, " + (t.buttonshadowopacity ? t.buttonshadowopacity / 100 : "0.3") + ")"),
            "");
...
function t_zeroForms__createErrorBox(r, t) {
    ...
    return (
        ...
        n.insertAdjacentElement("beforeend", t_zeroForms__createErrorBoxBtn("left")),
        n.insertAdjacentElement("beforeend", t_zeroForms__createErrorBoxBtn("right")),
...
function t_zeroForms__getBottomText(t, e, r, o, n) {
    ...
    return ["cb", "cbx"].some(function (t) {
        ...
        ? ((i = t_zeroForms__createLabel("checkbox", "", !1)).classList.add("t-text"),
          i.classList.add("t-text_xxs"),
          e.inputtitlecolor && (i.style.color = e.inputtitlecolor),
          t_zeroForms__appendMainSettingToField((a = document.createElement("input")), { name: "form_bottom_checkbox" }, "checkbox", "t-checkbox"),
          a.setAttribute("data-tilda-req", "1"),
          "cbx" === e.formbottomcb && (a.checked = !0),
          i.insertAdjacentElement("beforeend", a),
          ((a = t_zeroForms__createIndicator("checkbox", e.inputelscolor, !1)).style.width = "15px"),
          (a.style.height = "15px"),
          (a.style.marginRight = "5px"),
          i.insertAdjacentElement("beforeend", a),
          (a = document.createElement("span")).classList.add("t-checkbox__labeltext"),
          (a.innerHTML = n),
          i.insertAdjacentElement("beforeend", a),
          (a = t_zeroForms__createSelector(r, t, ".t-form__bottom-text .t-checkbox__indicator:after")),
          (r = e.inputelscolor ? "color: " + e.inputelscolor + ";" : ""),
          t_zeroForms__setScriptOrStyle("t-zero-form-btn-styles-" + t, "", a + "{" + (r += "left:3px;top:0;height:6px;") + "}", "style", o),
          i)
        : (((t = document.createElement("span")).innerHTML = n), t);
}
function t_zeroForms__animateInputs(t, o, e, r) {
    var n = t_zeroForms__createSelector(e, r, ""),
        ...
        a =
            ...
            t_zeroForms__setScriptOrStyle("t-zero-form-anim-styles-" + e + "-" + r, "", (i = o.inputcolor ? i + (n + ".t-input__vis-ph") + "{color:" + o.inputcolor + ";}" : i), "style", t),
    ...
    Array.prototype.slice.call(document.querySelectorAll(n + ".t-input:not(.t-inputquantity):not(.t-input-phonemask__wrap):not(.t-input-phonemask):not(.t-input__own-answer)")).forEach(function (t) {
        ...
        r &&
            ...
            o.inputfontsize && ((e.style.fontSize = o.inputfontsize + "px"), (e.style.height = parseInt(o.inputfontsize, 10) + 1 + "px")),
            (e.textContent = r),
...
function t_zeroForms__appendStylesToField(t, e) {
    ...
    t.classList.contains("t-input-phonemask__wrap") &&
        ((o = t.querySelector(".t-input-phonemask__select-code")) && (o.style.fontSize = e.fontSize),
        o && (o.style.fontWeight = e.fontWeight),
        (o = t.querySelector(".t-input-phonemask")) && (o.style.fontSize = e.fontSize),
        o && (o.style.fontWeight = e.fontWeight));
}
...
function t_zeroForms__setScriptOrStyle(t, e, r, o, n) {
    ...
    document.getElementById(t) ||
        ...
        r
            ? (a.textContent = r)
            : ("script" === o ? ((a.src = i + "/js/" + e), (a.async = !0), (a.charset = "utf-8")) : "link" === o && ((a.href = i + "/css/" + e), (a.rel = "stylesheet")),
              (a.onerror = function () {
        ...
        ("style" === o && r ? r : document.body).insertAdjacentElement("beforeend", a));
}
...
function t_zeroForms__isFormOutside(e) {
    var t = ["data-animate-sbs-opts", "data-animate-style"].some(function (t) {
            return e.hasAttribute(t);
        }),
        r = e.closest(".t396__artboard");
    if (!r || t) return !1;
    var t = r.getBoundingClientRect(),
        o = e.getBoundingClientRect(),
        n = t.right + window.pageXOffset;
    if (o.right < 0 && 0 < n) return !0;
    r = !!r && r.getAttribute("data-artboard-ovrflw");
    if ("auto" === r || "visible" === r) return !1;
    var r = t396_zeroForms__getScaleFactor(e),
        o = t_zeroForms__setScaleFactor(o.left, r),
        r = t_zeroForms__setScaleFactor(parseInt(e.style.top, 10), r) || 0,
        i = (r < 0 && -50 < r && (r = 0), e.hasAttribute("data-animate-fix")),
        a = "scroll" === e.getAttribute("data-animate-prx"),
        t = 0 < t.height && r > t.height && !a;
    return (r < 0 && !i && !a) || t || n < o;
}
...
function t_zeroForms__initQuanityClickCount(t) {
    ...
    t &&
        ...
        t ? 0 < e.value && ((e.value = Number(e.value) - 1), e.dispatchEvent(r)) : 0 <= e.value && ((e.value = Number(e.value) + 1), e.dispatchEvent(r)));
}
...
function t_zeroForms__createFormObj(t, e) {
    ...
    return (
        ...
        (r.shouldUseTwoColumnRadioImg = 799505628 < t),
        r
    );
}
function t_zeroForms__onFuncLoad(r, o) {
    ...
    "function" == typeof window[r]
        ? o()
        : ((n = Date.now()),
          (i = new Error(r + " is undefined")),
          setTimeout(function t() {
              var e = Date.now();
              if ("function" == typeof window[r]) o();
              else {
...
function t_zeroForms__placeFormIntoColumns(t) {
    var e, r;
    "h" !== t_zeroForms__getFieldValue(t, "data-field", "inputpos") &&
        (e = t.querySelector(".t-form__inputsbox")) &&
        0 !== (r = t.querySelectorAll(".t-input-group_widthdef, .t-input-group_inrow")).length &&
        (e.classList.add("t-form__inputsbox_flex"),
        e.classList.add("t-form__inputsbox_inrow"),
        Array.prototype.forEach.call(r, function (t) {
            if (t && t.classList.contains("t-input-group_inrow-withsibling")) {
                var e = t.nextElementSibling,
                    r = ["rd", "ri", "uc", "ws", "hd", "fr", "st"].filter(function (t) {
                ...
                if (
                    ...
                    0 !== r.length ||
                    !(
                        (e.classList.contains("t-input-group_inrow") && !t.classList.contains("t-input-group_widthdef")) ||
                        (t.classList.contains("t-input-group_widthdef") && e.classList.contains("t-input-group") && !e.classList.contains("t-input-group_inrow"))
                    )
                )
        ...
        0 < (e = t.querySelectorAll(".t-input-group_inrow.t-input-group_inonerow.t-input-group_inrow-last")).length && t_zeroForms__moveFieldToNextRow(e),
        0 < (r = t.querySelectorAll(".t-input-group_widthdef.t-input-group_inrow-last")).length && t_zeroForms__combineFieldsWithDefWidth(r));
}
...
function t_zeroForms__setFieldsRowClasses(t, e) {
    var r = t.inputWidth;
    void 0 !== r && (e.classList.add("t-input-group_inrow"), e.classList.add({ "1_4": "t-input-group_width25", "1_3": "t-input-group_width33", "1_2": "t-input-group_width50", 1: "t-input-group_width100" }[r])),
...
function t_zeroForms__setRadioRowClasses(t, e) {
    var r = t.radioPosition,
        o =
            (void 0 !== r && "" !== r && (e.classList.add("t-input-block_rd-flex"), (o = { hor: "", "1_4": "t-input-block_rd-width25", "1_3": "t-input-block_rd-width33", "1_2": "t-input-block_rd-width50" }[r]) && e.classList.add(o)),
            t.radioPositionMobile);
...
function t396_zeroForms__getScaleFactor(t) {
    ...
    if (!t || !t.classList.contains("t396__artboard_scale")) return 1;
    t = t.getAttribute("data-artboard-recid");
    return (t && window.tn["ab" + t] && window.tn["ab" + t].scaleFactor) || window.tn_scale_factor || 1;
}
function t396_zeroForms__setBrowsersInfo() {
    var t, e, r;
    void 0 === window.isOnlyScalable &&
        ((e = (t = window.navigator.userAgent.match(/Firefox\/([0-9]+)\./)) ? parseInt(t[1], 10) : 126),
        (r = ((r = window.navigator.userAgent.match(/Chrome\/([0-9]+)\./)) && parseInt(r[1], 10)) || 0),
...
(window.t_zeroForms__browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2)),
    ...
    window.t_zeroForms__isiOS && null !== (version = navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/)) && (window.t_zeroForms__iOSMajorVersion = parseInt(version[1], 10)),
    t_zeroForms__onReady(function () {
        var t = document.getElementById("allrecords");
